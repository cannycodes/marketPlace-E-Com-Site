...
const  getProducts = async() => {
  const res = await fetch(`https://5wa0d9vm.api.sanity.io/v2023-06-24/data/query/production?query=*%5B_type%20%3D%3D'products'%20%26%26%20productCategory%5B0%5D%20%3D%3D%20'kids'%5D`);
